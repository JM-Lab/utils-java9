...
==============================
## version
[![Maven Central](https://maven-badges.herokuapp.com/maven-central/kr.jmlab/jmlab-utils-java9/badge.svg)](http://search.maven.org/#artifactdetails%7Ckr.jmlab%7Cjmlab-utils-java9%7C0.1.6.1%7Cjar)
...
Gradle:
```groovy
compile 'kr.jmlab:jmlab-utils-java9:0.1.6.1'
```
Maven:
```xml
<dependency>
...
Checkout the source code:
    ...
    cd utils-java9
    git checkout -b 0.1.6.1 origin/0.1.6.1
    mvn install
